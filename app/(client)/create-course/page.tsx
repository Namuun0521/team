  ...
  return (
    <div className="bg-[#F5F7FB] min-h-screen py-[40px]">
      <div className="max-w-[768px] mx-auto flex flex-col gap-[32px]">
        ...
        <div>
          <h1 className="text-[32px] font-bold text-[#0F172A] mb-[8px]">Хичээлээ оруулах</h1>
          <p className="text-[16px] text-[#64748B]">Өөрийн ур чадвараа бусадтай хуваалцаж, орлого олж эхлээрэй. Мэдээллээ үнэн зөв бөглөнө үү.</p>
        </div>

        <Card className="rounded-[16px] border-[#E5E7EB] bg-white">
          <CardContent className="p-[30px]">
            <div className="mb-[20px]">
              <p className="text-[14px] font-semibold mb-[6px] text-[#64748b]">ХИЧЭЭЛИЙН ГАРЧИГ</p>
              <Input value={title} onChange={e => setTitle(e.target.value)} placeholder="Жишээ:  График дизайны анхан шатны хичээл" className="h-[64px] rounded-[12px] bg-[#F8FAFC]" />
            </div>
            ...
            <div className="flex gap-[24px] mb-[20px]">
              ...
              <div className="flex-1">
                ...
                <div className="relative"><span className="absolute left-[12px] top-[16px] text-[#64748B]">₮</span>
                  <Input value={price} onChange={e => setPrice(e.target.value)} placeholder="25,000" className="h-[56px] rounded-[12px] pl-[28px]" />
                </div>
              </div>
            </div>

            <div className="mb-[20px]">
              <p className="text-[14px] font-semibold mb-[6px] text-[#64748b]">ДЭЛГЭРЭНГҮЙ ТАЙЛБАР</p>
              <Textarea value={description} onChange={e => setDescription(e.target.value)} placeholder="Энэхүү хичээлээр суралцагч юу сурч мэдэх вэ? Таны туршлага юу вэ?" className="h-[140px] rounded-[12px]" />
            </div>

            <div className="mb-[30px]">
              <p className="text-[14px] font-semibold mb-[10px] text-[#64748b]">ХИЧЭЭЛИЙН НҮҮР ЗУРАГ</p>
              ...
              {imageUrl && <img src={imageUrl} className="mt-3 rounded-lg w-[200px]" />}
            </div>

            <div className="flex justify-between items-center">
              <span onClick={() => router.push("/profile")} className="text-[#64748B] text-[14px] cursor-pointer">Буцах</span>
              <Button onClick={handleSubmit} disabled={loading || uploading} className="bg-[#135BEC] h-[56px] px-[26px] rounded-[12px] text-[18px] text-white gap-[6px]">
