      ...
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[#64748B]">
              Авсан үйлчилгээ болон үнэлгээ өгөх
            </p>
          </div>
        </div>
        ...
        {completedBookings.length > 0 && (
          <div className="mb-8">
            ...
            <div className="space-y-4">
              {completedBookings.map((booking) => {
                const justSubmitted = submittedIds.has(booking.id);
                const hasExistingReview = booking.existingReview !== null;
                const alreadyReviewed = hasExistingReview || justSubmitted;
                const isOpen = openReviewId === booking.id;
                const review = getReview(booking.id, booking.course.id);
                const freelancerName =
                    ...
                    <CardContent className="p-0">
                      <div className="flex flex-col sm:flex-row">
                        ...
                        <div className="flex flex-1 flex-col p-5 gap-3">
                          ...
                          {/* Аль хэдийн үнэлгээ өгсөн бол харуулах */}
                          {hasExistingReview && !justSubmitted && (
                            <div className="rounded-xl border border-green-200 bg-green-50 p-4">
                              <div className="flex items-center justify-between">
                                ...
                                <StarDisplay
                                  rating={booking.existingReview!.rating}
                                />
                              </div>
                          ...
                          {/* Үнэлгээ өгөөгүй бол товч харуулах */}
                          {!alreadyReviewed && !isOpen && (
                            <div className="rounded-xl border border-yellow-200 bg-yellow-50 px-4 py-3">
                              <p className="text-sm font-semibold text-yellow-800">
                                🌟 Та энэ ажилд үнэлгээ өгнө үү?
                              </p>
                              <p className="mt-0.5 text-xs text-yellow-700">
                                Таны санал бодол бусад суралцагчдад маш их тус
                                болно.
                          ...
                          {isOpen && !alreadyReviewed && (
                            <div className="rounded-xl border border-blue-200 bg-blue-50 p-4 space-y-3">
                              ...
                              <Textarea
                                placeholder="Та өөрийнхөө сэтгэгдлээ бичнэ үү... (заавал биш)"
                                value={review.comment}
                                onChange={(e) =>
                                  setReview(booking.id, {
                                    comment: e.target.value,
