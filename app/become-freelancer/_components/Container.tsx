...
const DEMO_DATA: schemaType = {
  name: "Батбаяр Ганболд",
  phone: "99112233",
  email: "turboldnamuun@gmail.com",
  bio: "Би 5 жилийн туршлагатай график дизайнер. Adobe Photoshop, Illustrator, Figma зэрэг программуудыг чөлөөтэй ашигладаг. Брэнд дизайн, лого, UI/UX дизайн зэрэг чиглэлээр ажилладаг. Олон улсын болон дотоодын компаниудтай хамтран ажилласан туршлагатай.",
...
export const Container = () => {
  ...
  const fillDemo = () => {
    form.setValue("name", DEMO_DATA.name);
    form.setValue("phone", DEMO_DATA.phone);
    form.setValue("email", DEMO_DATA.email);
    form.setValue("bio", DEMO_DATA.bio);
    form.setValue("skills", DEMO_DATA.skills);
    setPreview(DEMO_AVATAR);
    toast.success("Demo мэдээлэл бөглөгдлөө!");
  };
        ...
        <form className="space-y-12" onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <div className="flex justify-end">
            <button
              type="button"
              onClick={fillDemo}
              className="flex items-center gap-2 rounded-xl border-2 border-dashed border-blue-300 bg-blue-50 px-4 py-2.5 text-sm font-semibold text-blue-600 transition hover:bg-blue-100 hover:border-blue-400"
            >
